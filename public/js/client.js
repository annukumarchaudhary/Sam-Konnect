...
/**
 * Configuration for controlling the visibility of buttons in the SamKonnect client.
...
function shareRoomByEmail() {
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            const email = '';
            const emailSubject = `Please join our SamKonnect Video Chat Meeting`;
    ...
    Swal.fire({
        ...
        <div id="about">
            ...
            Email:<a 
                ...
                href="mailto:miroslav.pejic.85@gmail.com?subject=SamKonnect info"> 
...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'Do you want to rate your Sam Konnect experience?',
        confirmButtonText: `Yes`,
        denyButtonText: `No`,
        showClass: { popup: 'animate__animated animate__fadeInDown' },
        hideClass: { popup: 'animate__animated animate__fadeOutUp' },
